...
public class AggregatingMessageGroupProcessorHeaderTests {
	...
	@BeforeEach
	public void setup() {
		this.defaultProcessor.setBeanFactory(TestUtils.createTestEvaluationContext());
		this.methodInvokingProcessor.setBeanFactory(TestUtils.createTestEvaluationContext());
	}
