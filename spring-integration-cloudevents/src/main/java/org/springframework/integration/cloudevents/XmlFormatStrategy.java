...
/**
 * Serializes a {@link CloudEvent} as XML as an implementation of the {@link FormatStrategy} interface.
 *
 * @author Glenn Renfro
 * @since 7.0
 */
public class XmlFormatStrategy implements FormatStrategy {
	...
	/**
	 * Serializes the payload {@link CloudEvent} to the XML format.
	 *
	...
	public byte[] toByteArray(CloudEvent cloudEvent) {
		return xmlFormat.serialize(cloudEvent);
	}
